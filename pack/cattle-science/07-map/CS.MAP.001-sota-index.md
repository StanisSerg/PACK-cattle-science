...
| CS.SOTA.029 | Aschenbach et al. | 2010 | Review | `#глюконеогенез` `#пропионат` `#печень` | JDS версия обзора глюконеогенеза |
...
| CS.SOTA.033 | Kupczyński et al. | 2020 | Review | `#глицерол` `#кетоз` `#лечение` | Глицерол как лечение кетоза (Animals 1396) |
| CS.SOTA.034 | Litherland et al. | 2025 | Field-study | `#дотоеловый-период` `#глюконеогенез` `#печень` | Питание до отёла меняет глюконеогенез |
