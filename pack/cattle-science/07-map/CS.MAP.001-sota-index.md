...
| 🌾 **feeding** | 40 | [Перейти →](./sota-index/CS.SOTA.feeding.index.md) | Кормление, метаболизм, переходный период |
| 🏥 **health** | 44 | [Перейти →](./sota-index/CS.MAP.001-health.md) | Здоровье, кетоз, иммунитет, печень |
...
*Версия 2.1 — Обновлено: 2026-04-01*  
*Автоматический подсчёт: 101 SoTA*
