...
> **Генерация:** Автоматическая через `rule_engine/generate_productivity_report.py` (rule_engine удалён 2026-08-09, пересоздание запланировано)
...
|-----------|-----|-----------|-------------|------------|--------------------------------|--------------|
| [ID-001] | [X] | [XX.X] | [XX.X] | [-XX]% | [RULE-002/RULE-006/RULE-011/etc] | [Действие] |
...
- [ ] Проверить всех коров с критическим отклонением по RULE-002 (SCK/кетоз), RULE-006 (метрит), RULE-011 (мастит)
