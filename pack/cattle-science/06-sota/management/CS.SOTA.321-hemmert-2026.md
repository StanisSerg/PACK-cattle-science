...
![Figure 1](CS.SOTA.321-hemmert-2026-media/page-03-figure-1.png)
...
![Figure 2](CS.SOTA.321-hemmert-2026-media/page-04-figure-1.png)
...
> **Примечание:** Медиа-файлы для Figure 3–9 и Tables 1–6 отсутствуют в инвентаре. Данные транскрибированы из первичного источника (PDF, p. 3725–3747). При наличии полных скриншотов их следует добавить в директорию `CS.SOTA.321-hemmert-2026-media/` и вставить markdown-ссылки.
