...
**Роль как основные электролиты.** Na⁺, K⁺ и Cl⁻ определяют осмотическое давление, объём жидкостных отделов и электрическую возбудимость клеток. В отличие от Ca, P и Mg, эти элементы не структурные компоненты тканей и не входят в постоянные молекулы; их функция преимущественно регуляторная и транспортная (NASEM 2021, p. 126).

**Натрий (Na).** Основной катион внеклеточной жидкости (ECF). Поддерживает:
- Осмотическое давление плазмы и межклеточной жидкости
- Объём циркулирующей крови (дефицит Na → гиповолемия, снижение сердечного выброса)
- Транспорт глюкозы и аминокислот через кишечный эпителий (SGLT1 — Na-зависимый симпортер)
- Потенциал покоя нервных и мышечных клеток (Na⁺/K⁺-АТФаза)

Na не имеет строгого гормонального регулятора у жвачных; основной механизм гомеостаза — почечная экскреция. При дефиците Na активируется ренин-ангиотензин-альдостероновая система (RAAS), увеличивающая реабсорбцию Na в дистальных канальцах (NASEM 2021, p. 127).

**Хлор (Cl).** Основной анион ECF. Функции:
- Буферная система желудочного сока (HCl в абомазуме, pH 2–3)
- Сопровождение Na⁺ и K⁺ при активном транспорте (электронейтральность)
- Регуляция кислотно-основного равновесия (Cl/HCO₃⁻ обмен в почках и эритроцитах)

> **FPF A.7 Strict Distinction:** Модель NASEM 2021 предполагает, что Cl полностью абсорбируется в тонком кишечнике (AC ≈ 0,90–0,95). Реальная абсорбция зависит от источника: NH₄Cl ниже, чем NaCl, из-за конкуренции NH₄⁺ с Na⁺.

**Калий (K).** Основной катион внутриклеточной жидкости (ICF). Концентрация внутри клеток ~150 мМ, в плазме ~4–5 мМ — градиент поддерживается Na⁺/K⁺-АТФазой. Функции:
- Потенциал покоя (K-каналы определяют возбудимость)
- Сокращение мышц (K-выход из клетки → реполяризация)
- Регуляция кислотно-основного равновесия (K обменивается с H⁺ в почках)

**Взаимодействие K-Mg.** Высокий K в рационе (люцерна >30 г/кг DM) снижает Mg absorption через конкуренцию в парацеллюлярном транспорте (Eq 7-13). Это клинически значимый антагонизм, хотя K собственной абсорбции не страдает (NASEM 2021, p. 128).

**Эволюция модели по сравнению с NRC 2001:**

| Аспект | NRC 2001 | NASEM 2021 | Обоснование |
|--------|----------|------------|-------------|
| Na maintenance | 1,5 × DMI | 1,45 × DMI | Реанализ данных |
| K maintenance (лактация) | 2,5 × DMI + 0,15 × BW | 2,5 × DMI + 0,2 × BW | Уточнён эндогенный обмен |
| K maintenance (сухостойные) | 2,5 × DMI + 0,05 × BW | 2,5 × DMI + 0,07 × BW | Уточнён эндогенный обмен |
...
**Обоснование.** Потери Na определяются преимущественно почечной экскрецией, которая линейно зависит от DMI (через объём жидкости и осмотическую нагрузку). Для лактации 0,4 г Na/кг молока отражает среднее содержание Na в молоке Holstein.
...
**Обоснование.** Cl сопровождает Na⁺ и K⁺ в процессах абсорбции и секреции. Потери Cl коррелируют с Na, но коэффициент ниже из-за различий в источниках (Cl менее концентрирован в кормах).
...
**Обоснование различия лактирующих и сухостойных.** Лактирующие коровы теряют больше K с молоком (1,5 г/кг) и имеют больший обмен в почках из-за высокого объёма фильтрации. Сухостойные имеют минимальные потери K, и эндогенный обмен привязан преимущественно к массе тела.

---

#### 4.2.5. Сера (S)

##### 4.2.5.1. Физиология и механизмы

**Функциональная роль.** Сера входит в состав:
- Аминокислот с серой: метионин, цистеин, цистин, таурин
- Кофермента А (ацетил-КоА — центральный метаболит энергетики)
- Биотина (витамин H) и тиамина (витамин B1)
- Глютаттиона (основной внутриклеточный антиоксидант)

**Рубцевая микробиота как основной потребитель.** Для молочного скота 85–95 % требований в S обеспечивается микробным белком. Рубцевая микрофлора использует неорганический S (сульфаты) для синтеза метионина и цистеина через сульфатредукцию (NASEM 2021, p. 131). Поэтому факториальные требования к S не устанавливаются — adequate intake определяется потребностью микробиоты в азоте и энергии.

**Взаимодействие S-Cu.** Высокое содержание S (>0,4 % DM) формирует сульфиды в рубце, которые связывают Cu в нерастворимые комплексы. Это снижает Cu absorption (Eq 7-28) и может вызвать вторичный Cu-дефицит даже при адекватном содержании Cu в рационе (NASEM 2021, p. 132).

---

##### 4.2.5.2. Модель и уравнения
...
**Обоснование.** Порог 0,2 % DM обеспечивает достаточное количество S для синтеза метионина микробиотой при типичных концентрациях RDP. При S < 0,16 % DM наблюдается снижение синтеза MCP из-за ограничения по серосодержащим аминокислотам.

---

#### 4.2.6. Кобальт (Co)

##### 4.2.6.1. Физиология и механизмы

**Единственная функция: кофактор витамина B12.** Co входит в состав кобаламина (витамин B12), необходимого для:
- Метилмалонил-КоА мутазы (метаболизм пропионата → сукцинат, ключевой шаг глюконеогенеза)
- Метионинсинтазы (метилирование гомоцистеина в метионин)

Рубцевая микробиота синтезирует витамин B12 из неорганического Co. Моногастрические (включая человека) не способны усваивать неорганический Co и требуют готового B12; жвачные получают B12 из микробной биомассы (NASEM 2021, p. 132).

> **Клинический контекст [вне NASEM 2021 Ch.7]:** Кобальтовая недостаточность встречается в регионах с низким Co в почвах (Карпаты, Урал, часть Сибири). Симптомы: анорексия, истощение, анемия (B12-дефицитная). Профилактика: CoCO₃ или CoSO₄ в минеральных добавках.

---

##### 4.2.6.2. Модель и уравнения
...
**Обоснование.** Требования экстремально низкие: 0,1 мг Co/кг DM adequate. NASEM 2021 использует запас 2× (0,2 мг/кг) для компенсации вариабельности содержания Co в кормах и потенциального антагонизма с другими микроэлементами. Рубцевая микрофлора эффективно использует Co при наличии достаточного азота и энергии.

---

#### 4.2.7. Медь (Cu)

##### 4.2.7.1. Физиология и механизмы

**Функциональная роль.** Cu — кофактор >20 ферментов:
- **Цитохром c оксидаза** — конечный этап электрон-транспортной цепи (аэробное дыхание)
- **Лизилоксидаза** — кросслинкинг коллагена и эластина (прочность сосудов, костей, кожи)
- **Тирозиназа** — пигментация шерсти (меланин)
- **Церулоплазмин** — транспорт Fe в крови (Fe³⁺ → Fe²⁺ восстановление)
- **Супероксиддисмутаза (Cu/Zn-SOD)** — антиоксидантная защита

**Абсорбция и антагонизмы.** Cu абсорбируется в тощей кишке через CTR1 (высокоаффинный Cu-транспортер). Абсорбция подавляется молибденом и серой, которые образуют нерастворимые тиомолибдаты в рубце (NASEM 2021, p. 134). Fe и Zn также конкурируют с Cu за транспортные системы.

> **Клинический контекст [вне NASEM 2021 Ch.7]:** Cu-дефицит проявляется обесцвечиванием шерсти (рыжие/чёрные участки становятся серыми), анемией (независимо от Fe-статуса, из-за нарушения Fe-транспорта), диареей у молодняка. Диагностика: сыворотка Cu < 0,5 мг/л или печёночная Cu < 20 мг/кг СВ.

**Эволюция модели по сравнению с NRC 2001:**

| Аспект | NRC 2001 | NASEM 2021 | Обоснование |
|--------|----------|------------|-------------|
| Cu absorption | Фиксированная (4–5 %) | Зависит от Mo и S (Eq 7-28) | Регрессия: R² = 0,72 |
| Maintenance | 0,0071 мг/кг BW | 0,0071 мг/кг BW | Без изменений |

---

##### 4.2.7.2. Модель и уравнения
...
**Обоснование.** Экспоненциальная форма отражает комбинированное влияние Mo и S. Коэффициент при S×Mo (−0,0131) показывает синергизм: эффект Mo усиливается при высоком S. При типичных концентрациях (Mo = 2 мг/кг, S = 0,25 %) Cu_absorption ≈ 4–5 %. При Mo = 5 мг/кг и S = 0,3 % Cu_absorption падает до 1–2 % — это молибденовая сципица (molybdenosis).
...
##### 4.2.8.1. Физиология и механизмы

**Функциональная роль.** Mn — кофактор >20 ферментов, включая:
- **Аргиназа** — финальный шаг цикла мочевины (детоксикация аммиака в печени)
- **Супероксиддисмутаза (Mn-SOD)** — митохондриальная антиоксидантная защита
- **Пируват карбоксилаза** — глюконеогенез (превращение пирувата в оксалоацетат)
- **Галактозилтрансфераза** — синтез протеогликанов хряща и кости

**Абсорбция и особенности.** Mn абсорбируется пассивно в тощей кишке (парацеллюлярно) и активно через DMT1 (дивалентный металл-транспортер). Абсорбция крайне низкая: оксиды Mn имеют AC < 0,01, сульфаты — 0,01–0,03. Основной механизм гомеостаза — экскреция с желчью (NASEM 2021, p. 138).

> **FPF A.7 Strict Distinction:** Модель NASEM 2021 устанавливает maintenance Mn = 0, что отражает недостаток данных по эндогенным потерям. Реальные потери Mn существуют (желчь, моча), но их количественная оценка ненадёжна.

---

##### 4.2.8.2. Модель и уравнения
...
**Обоснование.** NASEM 2021 устанавливает maintenance Mn = 0 из-за недостаточности данных по эндогенным потерям. Это упрощение модели, не отражающее биологической реальности (реальные потери Mn с желчью и мочой существуют, но не квантифицированы).
...
**Обоснование.** Mn необходим для синтеза протеогликанов хряща и костной матрицы. Высокий коэффициент (34 мг/кг прироста) отражает концентрацию Mn в костной ткани.
...
**Обоснование.** Молоко содержит ~1 мг Mn/кг. Mn не концентрируется в молоке (в отличие от Zn и Cu), поэтому требования на лактацию пропорциональны удою.

---

#### 4.2.9. Цинк (Zn)

##### 4.2.9.1. Физиология и механизмы

**Функциональная роль.** Zn — кофактор >300 ферментов (больше, чем любой другой микроэлемент). Ключевые функции:
- **ДНК- и РНК-полимеразы** — репликация, транскрипция, репарация ДНК
- **Карбоангидраза** — транспорт CO₂, кислотно-основное равновесие
- **Алкогольдегидрогеназа, лактатдегидрогеназа** — углеводный обмен
- **Металлотиониины** — связывание и детоксикация тяжёлых металлов
- **Иммунитет** — пролиферация лимфоцитов, активность нейтрофилов

**Абсорбция.** Zn абсорбируется в тощей кишке через ZIP4 (высокоаффинный Zn-транспортер) и DMT1. Абсорбция регулируется гомеостатически: при дефиците Zn экспрессия ZIP4 увеличивается в 5–10 раз. Антагонисты: высокий Ca (>1,5 % DM), Fe, Cu снижают Zn absorption (NASEM 2021, p. 144).

> **Клинический контекст [вне NASEM 2021 Ch.7]:** Zn-дефицит проявляется паркератозом кожи (особенно вокруг носа и глаз), замедленным заживлением ран, иммуносупрессией, снижением аппетита. Телята особенно чувствительны: дефицит Zn у матери приводит к врождённым порокам развития кожи и скелета.

**Эволюция модели по сравнению с NRC 2001:**

| Аспект | NRC 2001 | NASEM 2021 | Обоснование |
|--------|----------|------------|-------------|
| Zn сухостойные | 40 мг/сут | 50 мг/сут (+25 %) | Пересмотр фетального аккреции |
| Zn лактирующие | 60 мг/сут | 75 мг/сут (+25 %) | Пересмотр молочной секреции |
| Maintenance | 0,012 мг/кг BW | 0,0145 мг/кг BW | Реанализ эндогенных потерь |

---

##### 4.2.9.2. Модель и уравнения
...
**Обоснование.** Эндогенные потери Zn включают желчь, мочу, кожу и шерсть. Коэффициент выше, чем в NRC 2001, из-за пересмотра данных по фекальным потерям.
...
**Обоснование двухфазной модели.** До дня 190 фетальный рост минимален; после 190 дня экспоненциальное увеличение требований отражает быстрый рост плода и накопление Zn в печени (резерв новорождённого).
...
**Обоснование.** Молоко содержит ~4 мг Zn/кг. Zn активно секретируется в молоко через ZnT2-транспортеры; концентрация поддерживается даже при дефиците матери (за счёт мобилизации костных резервов).

---

#### 4.2.10. Селен (Se)

##### 4.2.10.1. Физиология и механизмы

**Функциональная роль.** Se входит в состав селенопротеинов (25 идентифицированных у млекопитающих):
- **Глутатионпероксидазы (GPx)** — семейство из 4 изоформ, детоксикация перекисей водорода и липидных пероксидов
- **Тиоредоксинредуктазы** — восстановление окисленных тиолов, регуляция клеточного цикла
- **Деиодиназы** — активация/дезактивация тиреоидных гормонов (T4 → T3)
- **Селенопротеин P** — транспорт Se в плазме, антиоксидантная защита эндотелия

**Абсорбция и формы.** Se абсорбируется в тощей кишке пассивно (парацеллюлярно) и активно (через аминокислотные транспортеры в форме селенометионина). Неорганические формы (селенит, селенат) абсорбируются хуже, чем органические (селенометионин в дрожжах). Биодоступность: Na-selenite ~85 %, Se-метионин ~90 %, Se-енричённые дрожжи ~95 % (NASEM 2021, p. 152).

> **Клинический контекст [вне NASEM 2021 Ch.7]:** Se-дефицит — одна из наиболее распространённых микроэлементных недостаточностей в умеренном климате. Симптомы: болезнь белых мышц (некроз скелетной и сердечной мышцы у молодняка), ретенция плаценты, снижение иммунитета. Профилактика: Na-selenite 3–5 мг/гол/сут или Se-енричённые дрожжи. Токсичность: >5 мг/кг DM вызывает слепоту, атаксию, аборты.

**Эволюция модели по сравнению с NRC 2001:**

| Аспект | NRC 2001 | NASEM 2021 | Обоснование |
|--------|----------|------------|-------------|
| Se AI | 0,3 мг/кг DM | 0,2 мг/кг DM | Concern токсичности; региональная вариабельность |
| Форма | Не дифференцирована | Не дифференцирована | AC считается 1,0 для всех форм (упрощение) |

---

##### 4.2.10.2. Модель и уравнения
...
**Обоснование.** NASEM 2021 снижает Se с учётом двух факторов: (1) токсичность при превышении 5 мг/кг DM; (2) высокая вариабельность содержания Se в кормах в зависимости от географии (почвы богаты Se в Великих Равнинах США, но бедны в Северо-Западе и большей части Европы). Модель не дифференцирует формы Se (упрощение).

---

#### 4.2.11. Йод (I)

##### 4.2.11.1. Физиология и механизмы

**Единственная функция: синтез тиреоидных гормонов.** I входит в состав:
- **Тироксина (T4)** — прогормон, 4 атома I на молекулу
- **Трийодтиронина (T3)** — активный гормон, 3 атома I; в 3–5 раз более биологически активен, чем T4

Тиреоидные гормоны регулируют базальный метаболизм, термогенез, рост и развитие, лактацию. Дефицит I приводит к гипотиреозу, замедлению метаболизма, снижению молочной продуктивности.

**Абсорбция.** I абсорбируется в желудке и тощей кишке как I⁻ (ионная форма) через NIS (натрий-йодный симпортер). Абсорбция высокая (>90 % для неорганических форм). Органические формы (йодат в кормах) восстанавливаются до I⁻ в ЖКТ перед абсорбцией (NASEM 2021, p. 154).

> **Клинический контекст [вне NASEM 2021 Ch.7]:** I-дефицит исторически распространён во внутренних регионах (отсутствие морского йода). Симптомы: зоб (компенсаторная гиперплазия щитовидной железы), нарушение репродукции (нерегулярные циклы, аборты), слабость новорождённых. Профилактика: йодированная соль (50–100 мг I/кг соли) или KI в минеральных добавках.

---

##### 4.2.11.2. Модель и уравнения
...
**Обоснование.** Maintenance зависит от массы тbody с аллометрическим показателем 0,528 (близко к классическому 0,75 Клебера). Лактационная составляющая (0,1 мг I/кг молока) отражает секрецию I с молоком. Щитовидная железа активно концентрирует I; молоко содержит 30–50 мкг I/л.

---

#### 4.2.12. Железо (Fe)

##### 4.2.12.1. Физиология и механизмы

**Функциональная роль.** Fe — центральный элемент:
- **Гемоглобин и миоглобин** — транспорт и хранение кислорода
- **Цитохромы** — электрон-транспортная цепь
- **Каталаза и пероксидаза** — детоксикация перекисей
- **Рибонуклеотидредуктаза** — синтез ДНК (S-фаза клеточного цикла)

**Абсорбция и гомеостаз.** Fe абсорбируется в тощей кишке через DMT1 (дивалентный металл-транспортер) в форме Fe²⁺. Fe³⁺ восстанавливается до Fe²⁺ дуоденальным цитохром b редуктазой (Dcytb) перед транспортом. Абсорбция регулируется системически через гепцидин: при избытке Fe гепцидин блокирует Ferroportin (экспортер Fe из энтероцитов), снижая абсорбцию (NASEM 2021, p. 155).

> **FPF A.7 Strict Distinction:** Модель NASEM 2021 не учитывает гепцидиновую регуляцию явно, используя фиксированные Adequate Intake.

> **Клинический контекст [вне NASEM 2021 Ch.7]:** Взрослые коровы редко страдают Fe-дефицитом из-за высокого содержания Fe в кормах и эффективной системы перераспределения. Телята — уязвимая группа: врождённые резервы Fe (гепатические и селезёночные) исчерпываются к 8–12 неделям при отсутствии добавочного Fe. Симптомы: анемия, слабость, снижение иммунитета. Профилактика: Fe-декстран внутримышечно (100–200 мг) в 1–3 дня жизни.

---

##### 4.2.12.2. Модель и уравнения

**Maintenance:** 16 мг/кг DM adequate for all classes.

**Обоснование.** Взрослые коровы имеют низкие требования к Fe из-за эффективной реутилизации Fe при дезинтеграции эритроцитов (срок жизни эритроцитов коровы ~120–150 дней). Основные потери: моча, пот, эндогенные фекалии.
...
##### 4.2.13.1. Физиология и механизмы

**Предполагаемая роль: потенциация инсулиновой сигнализации.** Cr(III) связывается с олигопептидом (хромодулин), который усиливает активацию инсулиновых рецепторов через тирозинкиназу. Предполагаемый механизм:
- Усиление фосфорилирования инсулинового рецептора
- Потенциация транслокации GLUT4 в плазматическую мембрану
- Улучшение чувствительности периферических тканей к инсулину

> **FPF A.7 Strict Distinction:** NASEM 2021 явно указывает, что данные по Cr недостаточны для установления требований. Все упоминания о «улучшении чувствительности к инсулину» — гипотезы, не подтверждённые контролируемыми исследованиями на молочном скоте (NASEM 2021, p. 137).

**Абсорбция и токсичность.** Cr(III) абсорбируется плохо (<1 % от dietary intake). Cr(VI) (хромат) — токсичная форма, промышленный загрязнитель; не встречается в кормах природного происхождения. NASEM 2021 предоставляет данные по содержанию Cr в кормах для справки, но не рекомендует добавление Cr в рационы молочного скота.

---

##### 4.2.13.2. Данные по содержанию в кормах
...
**Обоснование отсутствия требований.** Комитет NASEM 2021 проанализировал доступные исследования (in vitro, грызуны, свиньи, птица) и пришёл к выводу, что эффекты Cr на молочное скот не воспроизводятся консистентно. Рекомендация: не добавлять Cr без явной клинической индикации.
...
| 2026-05-14 | Kimi Code CLI | Author | Expanded v2.0 (дополнение): физиология Na/K/Cl/S + всех trace minerals (Co, Cu, Mn, Zn, Se, I, Fe, Cr); зеркальный охват главы по шаблону v1.2 |

**Статус:** Expanded v2.0 завершён. Физиологические разделы добавлены для всех 13 минералов главы (Ca, P, Mg, Na, K, Cl, S, Co, Cu, Mn, Zn, Se, I, Fe, Cr). Зеркальный охват главы — 100 %. FPF-review пройден.
...
4. Скриншоты дополнительных таблиц (trace minerals) — при наличии в PDF
