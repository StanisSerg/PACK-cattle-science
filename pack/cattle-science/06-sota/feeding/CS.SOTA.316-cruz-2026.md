...
| Table 3 | Таблица | Дескриптивная статистика (WPCS) | `table-3-descriptive-wpcs.png` | ✅ Встроено |
...
> **Примечание:** Извлечены 7 PNG-изображений (Fig. 1, Tables 2–7). Supplemental figures доступны в оригинальной PDF-версии статьи (DOI: 10.3168/jds.2025-27446).
...
![Table 3 — Дескриптивная статистика (WPCS)](CS.SOTA.316-cruz-2026-media/table-3-descriptive-wpcs.png)
*Источник: Cruz et al., 2026, p. 3753 (Table 3). Средние, SD, минимум, максимум для WPCS subset (15 исследований, 96 средних значений).*
...
**Не предоставлен авторами.** Мета-анализ использовал SAS 9.4 (MIXED procedure). Для воспроизведения требуются исходные данные 42 исследований и скрипт SAS/PROC MIXED.

**Чек-лист управления ТХ силоса:**
- [ ] Траншея/бункер герметичен, грань уплотнена
- [ ] Плотность ≥ 700 кг СВ/м³
- [ ] ТХ в яме 21–30°C (первые 60 сут)
- [ ] При холодном климате — хранение ≥ 90 сут перед вскрытием
- [ ] При > 30°C — удаление ≥ 30 см/сут, герметизация грани
- [ ] pH при вскрытии < 4,2 (WPCS)
- [ ] Молочная кислота > 4,0% СВ
- [ ] NH3-N < 5% N
- [ ] Аэробная стабильность > 72 ч (ежеквартально)

### 11.2. Онлайн-ресурсы

| Ресурс | URL | Назначение |
|--------|-----|------------|
| Cornell Silage | https://blogs.cornell.edu/silageweb/ | Руководства по силосованию, калькуляторы плотности |
| Kansas State Silage | https://www.bookstore.ksre.ksu.edu/pubs/MF2174.pdf | Руководство по управлению силосными ямами |
