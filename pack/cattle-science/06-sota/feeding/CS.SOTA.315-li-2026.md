...
|----|-----|----------|------|--------|
| Fig. 1 | Диаграмма | PRISMA flowchart (литературный поиск) | `page-04-figure-1.png` | ✅ Встроено |
| Fig. 2 | Forest plot | Эффект Lys на удой | `page-06-figure-2.png` | ✅ Встроено |
| Fig. 3 | Forest plot | Эффект Lys на выход белка | `page-06-figure-3.png` | ✅ Встроено |
| Fig. 4 | Forest plot | Эффект Lys на концентрацию белка | `page-06-figure-4.png` | ✅ Встроено |
| Fig. 5 | Forest plot | Эффект Lys на выход жира | `page-07-figure-5.png` | ✅ Встроено |
| Fig. 6 | График | Доза/длительность vs продуктивность (spline) | `page-14-figure-6.png` | ✅ Встроено |
...
> **Примечание:** Извлечены 6 PNG-изображений (Figures 1–6). Supplemental tables и figures доступны в оригинальной PDF-версии статьи (DOI: 10.3168/jds.2025-27470).
