...
- **Evidence:** Random-effects model, 93 means из 28 исследований, Egger's test P = 0.043 (слабая асимметрия) (Roman-Garcia et al., 2026, p. 3766, Fig. 2).
...
Хром (Cr) — незаменимый микроэлемент, играющий ключевую роль в углеводном и липидном метаболизме через модуляцию инсулиновой сигнализации. Механизм:
1. **Chromodulin:** низкомолекулярный Cr-связывающий олигопептид, усиливающий тирозинкиназную активность инсулинового рецептора.
2. **IRS-1/PI3K/Akt:** Cr усиливает фосфорилирование IRS-1 на тирозине, активирует PI3K и Akt (серин 473), что улучшает транслокацию GLUT4 и утилизацию глюкозы.
3. **Подавление липолиза:** улучшенная инсулиновая чувствительность снижает уровни NEFA, что через отмену lipostatic mechanism увеличивает СВ.

В период transition и ранней лактации коровы испытывают инсулинорезистентность — физиологическую адаптацию, обеспечивающую приоритет молочной железе в захвате глюкозы. Добавление Cr потенциально смягчает инсулинорезистентность, не нарушая приоритета молока.

### 3.2. Литературный обзор

**Предыдущие мета-анализы:**
- Harris et al. (2019): обобщили общий эффект Cr на СВ и молоко, но без модераторов.
- Malik et al. (2023): подтвердили положительный эффект на СВ и молоко, но не исследовали оптимальную дозу.
...
- Egger's test: P = 0.043 (слабая асимметрия)
...
- P < 0.001 (значимо)
- I² = 82.6% (P < 0.001)
- Egger's test: P = 0.028 (слабая предвзятость)
