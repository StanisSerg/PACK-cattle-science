...
**Данные:** de Souza et al. (2018) показали, что обработка паром повышает переваримость крахмала на 5–8% независимо от концентрации (guess).
...
**Практическое решение:** Увеличивать NEL_maint на 10–15% при THI > 72 (guess). Альтернатива — использовать интегрированные модели (Hermance et al., 2021).
