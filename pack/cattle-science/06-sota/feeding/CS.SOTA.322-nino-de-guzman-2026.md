...
![Figure 1](CS.SOTA.322-nino-de-guzman-2026-media/page-06-figure-1.png)
...
![Figure 2](CS.SOTA.322-nino-de-guzman-2026-media/page-07-figure-1.png)
...
> **Примечание:** Медиа-файлы для Table 1, Table 2, Table 4–6, Table 8–9 и Figure 3 отсутствуют в инвентаре. Данные транскрибированы из первичного источника (PDF, p. 3818–3833). При наличии полных скриншотов их следует добавить в директорию `CS.SOTA.322-nino-de-guzman-2026-media/` и вставить markdown-ссылки.
