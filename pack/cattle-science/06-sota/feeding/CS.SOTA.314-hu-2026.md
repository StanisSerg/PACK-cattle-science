...
- **Machmuller et al., 2002** — лауриновая кислота: 89% in vitro, 76% in vivo. Настоящий мета-анализ: RR = 0,78 [0,65; 0,91] для лауриновой кислоты, высокая гетерогенность (I² = 76%).
