...
> **Уровень:** Фундаментальный (P0) | **Формат:** Референсная книга (book chapter) | **Время изучения:** 35–45 мин  
...
### 4.1. Классификация углеводов в кормах
...
NASEM 2021 не рекомендует использовать NFC для формулирования из-за кумуляции аналитических ошибок и неоднородности NDSC.
...
(Oba & Allen, 2003b). Отрицательная скорость при pH <5,8 отражает нетто-растворение микробной массы при подавлении фибролитической активности.

---

#### Equation 5-4: Влияние DMI на переваримость NDF

**Снижение переваримости NDF = 4,4 процентных пункта при увеличении DMI с 2,5 до 5,0% от живой массы**

(de Souza et al., 2018). Механизм: сокращение руминального времени удержания при высоком потреблении.
...
- «fNDF — это не просто клетчатка. Это защита от ацидоза. При fNDF <17% риск субклинического руминального ацидоза становится критическим.»
- «Пшеница — 79% руминального крахмала. Это не кукуруза. Не применяйте к ней одинаковые нормы fNDF.»
- «PSPS стоит $50. Ламинит от SARA — $500. Каждая неделя проверяйте размер частиц.»
