...
tags:
  ...
  - review
related:
  - id: CS.SOTA.056-lean-2006
    type: foundational
    note: "Hypocalcemia prevention and calcium metabolism in transition cows"
    relevance: high
  - id: CS.SOTA.064-bruner-2025
    type: extends
    note: "Anionic salts and DCAD manipulation for transition period"
    relevance: high
  - id: CS.SOTA.036-transition-period
    type: foundational
    note: "Transition period management including mineral considerations"
    relevance: medium
  - id: CS.SOTA.003-chebel-2016
    type: foundational
    note: "Systems comparison including nutritional management"
    relevance: medium
---
...
### Figure 1: Механизмы парацеллюлярной и трансцеллюлярной абсорбции

**[СКРИНШОТ] Figure 1: Enterocytes lining the gastrointestinal tract are connected to each other by tight junction proteins**

**Название в статье:** Figure 1. Enterocytes lining the gastrointestinal tract are connected to each other by tight junction proteins
**Источник:** Goff, 2018, стр. 2764
**Тип:** Схема/диаграмма
...
**Комментарий лектора:**
> "Смотрите, у нас есть два пути абсорбции минералов. При высокой концентрации минерала в рационе работает парацеллюлярная абсорбция — минералы проходят между клетками. При низкой концентрации включается трансцеллюлярный путь — активный перенос через клетку. Это критически важно для понимания биодоступности минералов."

---

### Figure 2: Структура эпителия рубца

**[СКРИНШОТ] Figure 2: The mucosal lining of the rumen, reticulum, and omasum comprises stratified squamous epithelial cells**

**Название в статье:** Figure 2. The mucosal lining of the rumen, reticulum, and omasum comprises stratified squamous epithelial cells
**Источник:** Goff, 2018, стр. 2768
**Тип:** Схема гистологическая
...
**Ключевые элементы для лекции:**
- 4 слоя эпителия — физическая защита от абразии кормом
- Гэп-джанкшены — синцитиум клеток, позволяющий ионам проходить между слоями
- Тесные контакты препятствуют проникновению микробов
- Неперемешиваемый водный слой создаёт микроклимат у поверхности

**Комментарий лектора:**
> "Обратите внимание — рубец выстлан не одним слоем клеток, а многими! Это защита от грубых кормов. Но есть гэп-джанкшены — каналы между клетками — которые позволяют ионам быстро проходить через все слои. Это делает рубец важным органом абсорбции, особенно для магния."

---

### Figure 3: Механизмы абсорбции кальция и фосфора

**[СКРИНШОТ] Figure 3: Calcium and phosphate absorption mechanisms in the small intestine**

**Название в статье:** Figure 3. Calcium and phosphate absorption mechanisms in the small intestine
**Источник:** Goff, 2018, стр. 2775
**Тип:** Схема молекулярных механизмов

**Описание:**
Детальная схема трансцеллюлярной абсорбции Ca и фосфата в тонком кишечнике:

**Абсорбция Ca (A):**
- 1,25-дигидроксивитамин D (D) связывается с витамин D рецептором (VDR) в ядре
- Стимулирует продукцию TRPV6 (кальциевый канал апикальной мембраны)
- Calbindin-D9K (CaBP) комплексует Ca²⁺ и переносит через клетку
- PMCA1 (Ca-ATPase) использует энергию ATP для выведения Ca
- 3Na⁺/Ca²⁺ обменник (витамин D-независимый) в базолатеральной мембране

**Абсорбция фосфата (B):**
- 1,25-дигидроксивитамин D стимулирует Na/фосфат ко-транспортёр
- Используется 2 или 3 Na⁺ ионов для ко-транспорта HPO₄²⁻
- Фосфат диффундирует через клетку и выходит через канал в базолатеральной мембране
- Na⁺/K⁺-ATPase поддерживает градиент натрия

**Ключевые элементы для лекции:**
- Витамин D регулирует оба пути абсорбции
- TRPV6 — ключевой кальциевый канал
- Calbindin-D9K предотвращает токсичность свободного Ca²⁺ в цитоплазме
- PMCA1 работает против огромного концентрационного градиента (5000-кратного)
- 3Na⁺/Ca²⁺ обменник — альтернативный путь

**Комментарий лектора:**
> "Вот детальный механизм абсорбции кальция. Витамин D — главный регулятор. Он включает синтез трёх белков: канал TRPV6 для входа кальция, белок-кальций CaBP для переноса через клетку и помпу PMCA1 для выгона кальция в кровь. Обратите внимание — насос работает против 5000-кратного градиента! Это активный транспорт, требующий энергии."

---

### Figure 4: Абсорбция Na и хлорида

**[СКРИНШОТ] Figure 4: Absorption of Na and chloride by small intestinal villus cells**

**Название в статье:** Figure 4. Absorption of Na and chloride by small intestinal villus cells
**Источник:** Goff, 2018, стр. 2773
**Тип:** Схема молекулярных механизмов

**Описание:**
Схема трансцеллюлярной абсорбции натрия и хлорида ворсинковыми клетками тонкого кишечника:
- Na⁺ может пересекать апикальную мембрану используя Na⁺/H⁺ обменники
- Na⁺ проникает вниз по электрохимическому градиенту
- Cl⁻ переносится параллельно
- 3Na⁺/2K⁺-ATPase в базолатеральной мембране поддерживает градиенты

**Ключевые элементы для лекции:**
- Na⁺/H⁺ обменник (NHE) — главный механизм входа натрия
- Электрохимический градиент Na⁺ движет абсорбцией
- Аквапорины позволяют воде следовать за осмотическим градиентом

**Комментарий лектора:**
> "Натрий — ключевой ион, создающий осмотический градиент для абсорбции воды и других веществ. Обменник NHE выталкивает H⁺ в просвет и затягивает Na⁺ в клетку. Это электронейтральный обмен."

---

### Figure 5: Секреция хлорида криптовыми клетками

**[СКРИНШОТ] Figure 5: Intestinal crypt cell secretion of chloride, followed by Na+ and water, into the lumen of the intestine**

**Название в статье:** Figure 5. Intestinal crypt cell secretion of chloride, followed by Na+ and water, into the lumen of the intestine
**Источник:** Goff, 2018, стр. 2774
**Тип:** Схема молекулярных механизмов

**Описание:**
Схема секреторной функции криптовых клеток кишечника:
- Нейротрансмиттеры и гормоны стимулируют секрецию
- Cl⁻ выводится через апикальную мембрану через каналы CFTR
- Na⁺ следует через парацеллюлярные пути
- Вода следует осмотически

**Ключевые элементы для лекции:**
- Криптовые клетки секретируют, ворсинковые — абсорбируют
- CFTR — цистический фиброз трансмембранный регулятор
- Нарушение баланса секреция/абсорбция → диарея

**Комментарий лектора:**
> "Важно понимать — в кишечнике есть две популяции клеток: ворсинковые абсорбируют, криптовые секретируют. Баланс между ними определяет, будет ли нетто-абсорбция или нетто-секреция. При диарее секреторная функция преобладает."

---

### Figure 6: Абсорбция магния в рубце

**[СКРИНШОТ] Figure 6: Rumen Mg absorption**

**Название в статье:** Figure 6. Rumen Mg absorption
**Источник:** Goff, 2018, стр. 2784
**Тип:** Схема молекулярных механизмов

**Описание:**
Схема абсорбции Mg²⁺ в рубце:
- Mg²⁺ пересекает апикальную мембрану клеток stratum granulosum двумя путями
- Главный механизм — электронейтральный Mg²⁺/H⁺ обменник
- Также возможен канал TRPM7
- Гэп-джанкшены позволяют Mg²⁺ диффундировать между слоями
- Базолатеральный 3Na⁺/Mg²⁺ обменник выводит Mg²⁺ из клетки

**Ключевые элементы для лекции:**
- Mg абсорбируется преимущественно из рубца и сетки
- Mg²⁺/H⁺ обменник — главный транспортёр
- 3Na⁺/Mg²⁺ обменник в базолатеральной мембране
