...
> **[вне NASEM]** Описанные механизмы абсорбции минералов основаны на данных моногастричных животных и клеточных культурах. Прямые измерения транспортеров в рубце и кишечнике жвачных ограничены. Модель предполагает консервативность молекулярных механизмов между видами.
...
| Fig. 4 | Схема | Абсорбция Na и Cl⁻ ворсинковыми клетками | `figure-4.png` | ✅ Встроено |
| Fig. 5 | Схема | Секреция Cl⁻ криптовыми клетками | `figure-5.png` | ✅ Встроено |
| Fig. 6 | Схема | Абсорбция Mg²⁺ в рубце | `figure-6.png` | ✅ Встроено |
| Fig. 7 | Схема | Абсорбция сульфата, йодида и марганца | `figure-7.png` | ✅ Встроено |
| Fig. 8 | Схема | Трансцеллюлярная абсорбция меди | `figure-8.png` | ✅ Встроено |
| Fig. 9 | Схема | Абсорбция железа | `figure-9.png` | ✅ Встроено |
| Fig. 10 | Схема | Трансцеллюлярная абсорбция цинка | `figure-10.png` | ✅ Встроено |

> **Примечание:** Все 10 фигур извлечены и встроены inline. Мусорные auto-page PNG удалены.
...
![Figure 7 — Абсорбция сульфата, йодида и марганца в тонком кишечнике](CS.SOTA.168-goff-2018-media/figure-7.png)
*Источник: Goff, 2018, p. 2793 (Figure 7).*
...
![Figure 8 — Трансцеллюлярная абсорбция меди энтероцитами](CS.SOTA.168-goff-2018-media/figure-8.png)
*Источник: Goff, 2018, p. 2798 (Figure 8).*
...
![Figure 9 — Абсорбция железа энтероцитами](CS.SOTA.168-goff-2018-media/figure-9.png)
*Источник: Goff, 2018, p. 2800 (Figure 9).*
...
![Figure 10 — Трансцеллюлярная абсорбция цинка энтероцитами](CS.SOTA.168-goff-2018-media/figure-10.png)
*Источник: Goff, 2018, p. 2809 (Figure 10).*
...
![Figure 1 — Механизмы парацеллюлярной и трансцеллюлярной абсорбции](CS.SOTA.168-goff-2018-media/figure-1-absorption-mechanisms.png)
...
![Figure 3 — Механизмы абсорбции Ca и фосфата](CS.SOTA.168-goff-2018-media/figure-3-ca-phosphate-absorption.png)
...
![Figure 2 — Структура эпителия рубца](CS.SOTA.168-goff-2018-media/figure-2-rumen-epithelium.png)
...
![Figure 6 — Абсорбция Mg²⁺ в рубце](CS.SOTA.168-goff-2018-media/figure-6.png)
*Источник: Goff, 2018, p. 2784 (Figure 6).*
...
![Figure 4 — Абсорбция Na и Cl⁻ ворсинковыми клетками](CS.SOTA.168-goff-2018-media/figure-4.png)
*Источник: Goff, 2018, p. 2773 (Figure 4).*

![Figure 5 — Секреция Cl⁻ криптовыми клетками](CS.SOTA.168-goff-2018-media/figure-5.png)
*Источник: Goff, 2018, p. 2774 (Figure 5).*
...
4. Выбрать источник минерала:
   ...
   ├── Для Mg: 
   │   ├── MgO — дёшево, низкая усвояемость (~20%)
   │   ├── MgSO₄ — дороже, высокая усвояемость (~55%)
   │   └── MgCl₂ — высокая усвояемость, отрицательная палатабельность
   ├── Для микроэлементов:
...
2. **Рубец функционирует не только как ферментационная камера, но и как орган абсорбции**
...
6. **"Избыток вредит"**
   ...
   - Баланс минералов определяет биодоступность, а не только концентрация в рационе
...
> **FPF A.7 Strict Distinction:** Механизмы абсорбции минералов описаны преимущественно на основе данных моногастричных животных и клеточных культур; прямые измерения транспортёров в рубце и кишечнике жвачных ограничены.
> **FPF A.6.3 ConservativeRetextualization:** Модель взаимодействий минералов основана на химических принципах конкуренции за транспортёры; количественные параметры взаимодействий в рубце жвачных требуют дополнительной валидации.
> **FPF A.10 Evidence Graph:** Обзор включает 100+ цитируемых источников с привязкой к молекулярным механизмам (Goff, 2018, p. 2763–2813) и статистическими данными по усвояемости.
...
**Вывод:** оптимальное соотношение минералов важнее их абсолютной концентрации [модель]. Модель предполагает, что взаимодействия между минералами следуют законам химической конкуренции за транспортёры и рецепторы.
