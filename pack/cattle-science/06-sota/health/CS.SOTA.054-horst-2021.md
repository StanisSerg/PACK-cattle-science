...
**Claim 1:** Традиционная парадигма (NEFA/кетоны/гипокальцемия → иммуносупрессия → заболевания) неэффективна: 50+ лет исследований не решили проблему переходного периода (Horst et al., 2021, p. 8380). Уверенность: 0,90 (исторический анализ, индустриальные данные).

**Claim 2:** Иммунная активация и воспалительный ответ — нормальный компонент биологии переходной коровы (Horst et al., 2021, p. 8384). Источники: молочная железа (инволюция, колонизация), родовая травма (ткани, последа), ЖКТ (микробиом, барьер). Уверенность: 0,85 (множественные исследования последнего десятилетия).

**Claim 3:** Патологическое (затяжное) воспаление индуцирует гипофагию через центральные механизмы (цитокины → гипоталамус → снижение аппетита) (Horst et al., 2021, p. 8388). Гипофагия приводит к гипокальцемии (↓ потребление Ca) и усиленной липомобилизации (↑ NEFA, ↑ кетоны). Уверенность: 0,80 (механистические исследования LPS, центральные инъекции цитокинов).

**Claim 4:** Изменения NEFA, кетонов и кальция — отражение (рефлексия), а не причина проблем (Horst et al., 2021, p. 8392). Они коррелируют с плохими исходами, но являются следствием иммунной активации или нормальной homeorhetic адаптации. Уверенность: 0,75 (авторский аргумент, логический анализ; прямые causal данные ограничены).

**Claim 5:** Глюкоза — центральный лимитирующий ресурс: > 90% печёночной глюкозы потребляется молочной железой в ранней лактации (~72 г/кг молока) (Horst et al., 2021, p. 8396). Иммунная система конкурирует за глюкозу, и гипофагия — адаптивный ответ, направленный на сохранение глюкозы для иммунитета и молока. Уверенность: 0,82 (калькуляции баланса глюкозы, изотопные исследования).
...
**Ключевые аргументы:**
- LPS-инфузия in vivo вызывает гипофагию, гипокальцемию и липомобилизацию — воспроизводя все «традиционные» симптомы без повышения NEFA как причины (Horst et al., 2021, p. 8388).
- Центральные инъекции IL-1β и TNFα вызывают анорексию у жвачных (Horst et al., 2021, p. 8389).
- > 90% глюкозы печени → молочная железа; иммунитет конкурирует за этот ресурс (Horst et al., 2021, p. 8396).
...
> **[вне NASEM]** Модель «глюкозного конфликта» основана на корреляционных данных и in vitro экспериментах. Прямые изотопные измерения распределения глюкозы между молочной железой и иммунитетом in vivo ограничены.

Глюкоза — предпочтительный субстрат для активированных иммунных клеток (макрофаги, нейтрофилы, лимфоциты). Анаэробный гликолиз (Warburg effect) обеспечивает быстрое производство АТФ и предшественников для синтеза нуклеотидов и аминокислот, необходимых для пролиферации и функции иммунных клеток. При иммунной активации потребление глюкозы иммунитетом может увеличиваться в 10–20 раз [модель] (Horst et al., 2021, p. 8397). Это создаёт «глюкозный конфликт»: молочная железа требует глюкозу для лактозы и энергии, иммунитет — для защиты. Гипофагия — компромисс: меньше корма → меньше энергии на пищеварение → больше глюкозы для приоритетных функций.
...
3. **Логическая последовательность:** Аргументация строится от критики старой парадигмы к обоснованию новой [вне NASEM], с механистическими объяснениями на каждом шаге. Модель предполагает, что все метаболические нарушения transition period имеют единый корень — иммунную активацию.
...
> **FPF A.7 Strict Distinction:** Предложенная модель (иммунная активация как корень проблем transition period) является интерпретацией существующей литературы, а не результатом прямого экспериментального доказательства.
> **FPF A.6.3 ConservativeRetextualization:** Калькуляции баланса глюкозы основаны на моделях; прямые изотопные измерения распределения глюкозы между молочной железой и иммунитетом in vivo ограничены.
> **FPF A.10 Evidence Graph:** Обзор включает 50+ цитируемых источников с привязкой к страницам (Horst et al., 2021) и статистическими метриками.
...
4. **Высокие кетоны:** Несмотря на функциональную роль кетонов, концентрации > 3,0 ммоль/л BHB ассоциированы с неврологическими симптомами (клинический кетоз), что выходит за рамки маркёрной роли.
...
A: Нет, но изменить интерпретацию. Раньше: целевой маркёр для контроля. Сейчас: вторичный маркёр, отражающий иммунную активацию/гипофагию. При высоких NEFA необходимо устранение первопричины (воспаление, снижение аппетита), а не только симптоматическое вмешательство.
