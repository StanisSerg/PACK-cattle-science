...
**Claim 6:** Механизм защитного эффекта включает PTH-опосредованную резорбцию кости и кишечную абсорбцию Ca, однако точный вклад серотонина остаётся неясным.
- **Уверенность:** 0,65 (косвенные данные: корреляция PTH↑ и Ca↑; механизм PTH/VDR/D3 подтверждён литературой; роль 5-HT — гипотетическая).
- **Evidence:** Discussion, p. 4612–4613.
