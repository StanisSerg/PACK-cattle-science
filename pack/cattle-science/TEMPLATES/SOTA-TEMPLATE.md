...
- [ ] **ОБНОВИТЬ ИНДЕКС (КРИТИЧНО):** CS.MAP.001-sota-index.md — см. правило ниже
- [ ] Проверить по ArchGate (должно быть ≥8)
- [ ] Закоммитить в git

#### ⚠️ ПРАВИЛО ОБНОВЛЕНИЯ ИНДЕКСА (ОБЯЗАТЕЛЬНО)

После создания КАЖДОЙ новой SoTA необходимо обновить индексный файл:

**Файл:** `PACK-cattle-science/pack/cattle-science/07-map/CS.MAP.001-sota-index.md`

**Шаги:**
1. Открыть CS.MAP.001-sota-index.md
2. Добавить строку в таблицу "Полный список SoTA" в соответствующем разделе
3. Добавить файл в таблицу "По структуре папок" (раздел соответствующей папки)
4. Обновить счётчик файлов в разделе "Обновление"
5. Обновить дату последнего обновления
6. При необходимости — добавить связи в раздел "Связи между источниками"
7. Сохранить файл

**Проверка:**
- [ ] SoTA отображается в полном списке
- [ ] SoTA отображается в структуре папок
- [ ] Счётчики файлов актуальны
- [ ] Дата обновления — сегодня

**Нарушение этого правила = неполный статус WP-75**
