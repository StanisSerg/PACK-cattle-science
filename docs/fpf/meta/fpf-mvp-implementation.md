...
> **Статус 2026-08-09:** `rule_engine/` удалён, пересоздание запланировано. Документ — историческая запись MVP-внедрения; упоминания `rule_engine/` и RULE-001 ниже относятся к состоянию на 2026-04-18.
